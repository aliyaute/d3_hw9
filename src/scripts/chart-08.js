...
function ready(datapoints) {
    ...
    drawTemp(svg1983, nested, -10, 10, 'lightgrey')
    drawTemp(svg1994, nested, -10, 10, 'lightgrey')
    drawTemp(svg2005, nested, -10, 10, 'lightgrey')
    ...
    function drawAllAreas(svg, startYear, endYear) {
      ...
      drawTemp(svg, nested, -10, -3, 'deepblue')
      drawTemp(svg, nested, -3, -0.9, 'navy')
      drawTemp(svg, nested, -0.9, 0.9, 'blue')
      drawTemp(svg, nested, 0.9, 3, 'pink')
      drawTemp(svg, nested, 3, 10, 'red')
    }
